...
• 현재 구간 백분위: {last_percentile_str}

📉 과거 비교 기준
• 10% 백분위수: {percentile_10_str}
• 1% 백분위수: {percentile_1_str}

※ 현재 구간 최소 드로우다운 값이 10% 백분위수 보다 낮아 지면 나스닥 100 손절
   현재 구간 최소 드로우다운 값이 1% 백분위수 보다 낮아 지거나
   현재 구간 최소 드로우다운 값이 10% 백분위수 보다 낮으면서
   현재 드로우다운이 10% 백분위수 보다 높아 지면 재진입
